...
public class Machine2CSVData {
    ...
    private Double min_id_gauge_value;
    private Double max_id_gauge_value;
    private Double actual_id_a_gauge_value;
    private Double actual_id_b_gauge_value;
    private Double min_load_value;
    private Double max_load_value;
    private Double actual_load_value;
    private String id_gauge_status;
    private String ball_press_status;
    ...
    public Double getMin_id_gauge_value() {
        return min_id_gauge_value;
    }

    public void setMin_id_gauge_value(Double min_id_gauge_value) {
        this.min_id_gauge_value = min_id_gauge_value;
    }

    public Double getMax_id_gauge_value() {
        return max_id_gauge_value;
    }

    public void setMax_id_gauge_value(Double max_id_gauge_value) {
        this.max_id_gauge_value = max_id_gauge_value;
    }

    public Double getActual_id_a_gauge_value() {
        return actual_id_a_gauge_value;
    }

    public void setActual_id_a_gauge_value(Double actual_id_a_gauge_value) {
        this.actual_id_a_gauge_value = actual_id_a_gauge_value;
    }

    public Double getActual_id_b_gauge_value() {
        return actual_id_b_gauge_value;
    }

    public void setActual_id_b_gauge_value(Double actual_id_b_gauge_value) {
        this.actual_id_b_gauge_value = actual_id_b_gauge_value;
    }
    ...
    public String getBall_press_status() {
        return ball_press_status;
    }

    public void setBall_press_status(String ball_press_status) {
        this.ball_press_status = ball_press_status;
    }
}
