...
public class Machine3CSVData {
    ...
    private String socket_press_status ;
    ...
    public String getSocket_press_status() {
        return socket_press_status;
    }

    public void setSocket_press_status(String socket_press_status) {
        this.socket_press_status = socket_press_status;
    }
}
